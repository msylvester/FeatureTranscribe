...
def combine_segments(segments):
    ...
    # Determine combined volume level
    if avg_volume < 0.1:
        volume_level = "quiet"
    elif avg_volume < 0.3:
        volume_level = "normal"
...
def transcribe_with_features(model, audio_path, device, min_duration=15.0):
    """Get transcription with timestamps and audio features, combining segments to meet minimum duration"""
    ...
    # Buffer for accumulating segments
    current_segments = []
    ...
    for segment in result["segments"]:
        ...
        # If we've reached or exceeded the minimum duration, combine and add to output
